...
leafFunction:
	...
	mov	QWORD PTR -136[rbp], 2
	mov	QWORD PTR -128[rbp], 3
	mov	QWORD PTR -120[rbp], 4
	mov	QWORD PTR -112[rbp], 5
	mov	QWORD PTR -104[rbp], 6
	mov	QWORD PTR -96[rbp], 7
	mov	QWORD PTR -88[rbp], 8
	mov	QWORD PTR -80[rbp], 9
	mov	QWORD PTR -72[rbp], 10
	mov	QWORD PTR -64[rbp], 11
	mov	QWORD PTR -56[rbp], 12
	mov	QWORD PTR -48[rbp], 13
	mov	QWORD PTR -40[rbp], 14
	mov	QWORD PTR -32[rbp], 15
